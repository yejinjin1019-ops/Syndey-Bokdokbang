...
export function ServicesHero() {
  ...
  return (
    <section style={{ backgroundColor: COLORS.green }}>
      <div className="max-w-[1400px] mx-auto px-5 md:px-10 pt-36 md:pt-44 pb-20 md:pb-28">
        <div className="max-w-2xl">
          ...
          <h1
            ...
            style={{ fontFamily: display, color: COLORS.ivory, fontSize: "clamp(34px,5vw,58px)", lineHeight: 1.16, letterSpacing: "-0.01em" }}
          >
